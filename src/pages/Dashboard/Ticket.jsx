  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mb-10">
        {[
          { title: 'Total Tickets' , count: 0, icon: <ListChecks className="text-yellow-100" size={18} />, color: 'from-yellow-400 to-yellow-600', bgColor: 'bg-gradient-to-br from-yellow-50 to-orange-50' },
          { title: 'Open', count: 0, icon: <AlertCircle className="text-blue-100" size={18} />, color: 'from-blue-400 to-blue-600', bgColor: 'bg-gradient-to-br from-blue-50 to-cyan-50' },
          { title: 'In Progress', count: 0, icon: <Clock className="text-indigo-100" size={18} />, color: 'from-indigo-400 to-indigo-600', bgColor: 'bg-gradient-to-br from-indigo-50 to-purple-50' },
          { title: 'Resolved', count: 0, icon: <CheckCircle className="text-green-100" size={18} />, color: 'from-green-400 to-green-600', bgColor: 'bg-gradient-to-br from-green-50 to-emerald-50' },
          { title: 'Overdue', count: 0, icon: <Clock className="text-red-100" size={18} />, color: 'from-red-400 to-red-600', bgColor: 'bg-gradient-to-br from-red-50 to-pink-50' },
        ].map((stat, i) => (
