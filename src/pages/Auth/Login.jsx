  ...
  return (
    <div className="flex items-center bg-gradient-to-r from-gray-200 to-gray-300 justify-center h-screen bg-cover bg-center overflow-hidden">
      <motion.div
        ...
        className="bg-white/20 backdrop-blur-xl shadow-xl rounded-2xl flex w-[1000px] h-[700px] overflow-hidden border border-white/30"
      >
        {/* Left Section */}
        <motion.div
        ...
        <motion.div
          ...
          className="w-1/2 bg-purple-100 flex flex-col items-center justify-center text-center p-6"
        >
